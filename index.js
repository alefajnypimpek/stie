...
const FILE_DOWNLOADS = [
  'assets/kretacz/l1.png',
  'assets/kretacz/l2.png',
  'assets/kretacz/l3.png',
...
const veryLongString = repeatStringNumTimes(repeatStringNumTimes('zostałeś zwbitowany!!1 ',100),1500) // - added by @9fm
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'wbitic')
  })
}
